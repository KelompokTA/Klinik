                ...
                <section class="col-lg-7 connectedSortable">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <ul class="todo-list" data-widget="todo-list">
                                <li>
                                    ...
                                    <span class="text">Datang tepat waktu</span>
                                </li>
                                <li>
                                    <span class="handle">
                                        <i class="fas fa-ellipsis-v"></i>
                                    ...
                                    <span class="text">Menyapa rekan kerja</span>
                                </li>
                                <li>
                                    <span class="handle">
                                        <i class="fas fa-ellipsis-v"></i>
                                    ...
                                    <span class="text">Membersihkan dan dan merapikan tempat kerja</span>
                                </li>
                                <li>
                                    <span class="handle">
                                        <i class="fas fa-ellipsis-v"></i>
                                    ...
                                    <span class="text">Berpakaian rapi dan siap bekerja</span>
                                </li>
                                <li>
                                    <span class="handle">
                                        <i class="fas fa-ellipsis-v"></i>
                                    ...
                                    <div class="icheck-primary d-inline ml-2">
                                        ...
                                        <label for="todoCheck5">Motivasimu untuk hari ini:</label>
                                    </div>
                                    <input type="text">
                                </li>
                            </ul>
                        ...
                        <div class="card-footer clearfix">
                            <button type="button" class="btn btn-info float-right"><i class="fas fa-smile-beam"></i> Saya siap bekerja</button>
                        </div>
                    </div>
                    <!-- /.card -->
                </section>
                        ...
                        <div class="card-footer bg-transparent">
                            <div class="row">
                                <div class="col-4 text-center">
                                    ...
                                    <div class="text-white">Positif</div>
                                </div>
                                <!-- ./col -->
                                <div class="col-4 text-center">
                                    <div id="sparkline-2"></div>
                                    <div class="text-white">Sembuh</div>
                                </div>
                                <!-- ./col -->
                                <div class="col-4 text-center">
                                    <div id="sparkline-3"></div>
                                    <div class="text-white">Meninggal</div>
                                </div>
                                <!-- ./col -->
                            </div>
                            <!-- /.row -->
