                                    ...
                                    <div class="post">
                                        <form role="form" action="<?= base_url('save_diagnosa'); ?>/<?= $id ?>" method="POST">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="diagnosa_primer" class="form-control" rows="4" placeholder="Masukan diagnosa primer ..."></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label>Diagnosa Sekunder</label>
                                                <textarea name="diagnosa_sekunder" class="form-control" rows="3" placeholder="Masukan diagnosa sekunder ..."></textarea>
                                            </div>
                                            <div class="form-group">
